...
function GlassTag({ label }: { label: string }) {
  return (
    ...
    >
      <span
        className="font-body font-medium text-body-sm sm:text-body lg:text-card text-nwcn-neutral-500 whitespace-nowrap"
      >
        {label}
      </span>
    </div>
    ...
    <div className="relative w-full max-w-[1440px] mx-auto bg-white">
      ...
      <AnimateOnScroll variant="fade-up" threshold={0.05}>
        <section className="flex flex-col items-center px-4 sm:px-8 lg:px-[79px] py-12 sm:py-16 lg:py-24 bg-white">
          ...
          {/* "학과 소개" 타이틀 */}
          <p className="font-body font-bold text-section text-nwcn-neutral-700 text-center mb-8 sm:mb-12">
            {t('intro')}
          </p>
          ...
          <div className="text-center max-w-[860px] px-4">
            ...
            <p className="mt-4 sm:mt-5 font-body font-normal text-caption sm:text-body-sm text-nwcn-neutral-500">
              {t('aka')}
            </p>
          </div>
        </section>
      ...
      <AnimateOnScroll variant="fade-up" threshold={0.05}>
        <section className="relative overflow-hidden bg-white px-4 sm:px-8 lg:px-[79px] py-12 sm:py-16 lg:py-24">
          ...
          <p className="font-body font-bold text-section text-nwcn-neutral-700 text-center mb-10 sm:mb-16">
            {t('goal')}
          </p>
