...
const STYLES = {
  desktop: {
    ...
    label: 'font-body font-extrabold text-page-1 text-nwcn-green leading-normal w-full',
    list: 'w-full font-body font-normal text-section text-nwcn-text-default',
  ...
  mobile: {
    ...
    label: 'font-body font-extrabold text-section text-nwcn-green leading-normal',
    list: 'font-body font-normal text-body-sm text-nwcn-text-default',
