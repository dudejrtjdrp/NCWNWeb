        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[79px]">
            ...
            <div className="mb-16">
              <div className="relative border border-nwcn-green/20 rounded-3xl overflow-hidden bg-gradient-to-br from-[#f8fffe] to-[#f0fff8] p-10 flex gap-10 items-center group hover:border-nwcn-green/50 transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="font-body text-[13px] text-[#aaa] mb-2">{ARCHIVE_DATA[0].description}</p>
                  <h2 className="font-brand font-bold text-nwcn-text-default mb-3 group-hover:text-nwcn-green transition-colors"
                    style={{ fontSize: 'clamp(28px, 4vw, 48px)', lineHeight: 1.1 }}>
                    {ARCHIVE_DATA[0].title}
                  </h2>
                  <p className="font-body text-[14px] text-[#888]">{ARCHIVE_DATA[0].theme}</p>
                </div>
                {/* 연도 워터마크 */}
          ...
          <div className="relative">
            ...
            <div className="space-y-6">
              {ARCHIVE_DATA.slice(1).map((item, idx) => (
